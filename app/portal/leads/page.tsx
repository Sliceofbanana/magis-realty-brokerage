...
import { TrendingUp, Zap, Plus, Download, Printer, LayoutGrid, List, MoreVertical } from "lucide-react";
...
const sources = [
  { label: "Web Inquiries", value: 42 },
  { label: "Referrals", value: 28 },
  { label: "Open House", value: 18 },
    ...
    <div>
      <div className="mb-8 flex flex-wrap items-start justify-between gap-4">
        ...
        <div className="flex flex-wrap gap-3">
          <StatCard icon={<TrendingUp size={18} />} label="New Leads" value="10 this week" iconBg="bg-gold-100 text-gold-600" />
          <StatCard icon={<Zap size={18} />} label="Response Rate" value="94% avg." iconBg="bg-navy-900 text-white" />
        </div>
      </div>
      ...
      <div className="rounded-2xl border border-black/5 bg-white shadow-sm">
        <div className="flex flex-wrap items-center justify-between gap-3 border-b border-black/5 p-4">
          ...
          <div className="flex items-center gap-2 text-gray-400">
            <button type="button" aria-label="Download" className="hover:text-navy-900">
              <Download size={16} />
            </button>
            <button type="button" aria-label="Print" className="hover:text-navy-900">
              <Printer size={16} />
            </button>
            <span className="ml-2 flex overflow-hidden rounded-lg border border-black/10">
        ...
        <div className="flex items-center justify-between border-t border-black/5 p-4 text-xs text-gray-400">
